  ...
  return (
    <Box>
      ...
      <Dialog open={modalOpen} onClose={handleCloseModal} maxWidth="sm" fullWidth>
        <Formik
          initialValues={
            editTarget ? { projectId: editTarget.projectId || '', name: editTarget.name || '' } : initialValues
          }
        ...
        >
          {({ errors, touched, isSubmitting }) => (
            <Form>
              <DialogTitle sx={{ fontWeight: 700 }}>{editTarget ? 'Edit Project' : 'Add Project'}</DialogTitle>
              <DialogContent>
